...
local function makeAuto(name)
    ...
    local func 
    local s = Backpack[name].GunClientHandler
    for i,v in pairs(getsenv(s)) do
...
local function modGun(nameOfGun,newCurrentammo,newMaxammo,newFireRate)
    local func 
    for i,v in pairs(guns.Guns) do
        if nameOfGun == v  then
            local s = Backpack[nameOfGun].GunClientHandler
    ...
    for i,v in pairs(guns.Shotguns) do 
        if nameOfGun == v then
            local s = Backpack[nameOfGun].GunClientHandler
